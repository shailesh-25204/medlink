        ...
        <div>
          <div className="lg:w-[570px]">
            ...
            <p className="text__para">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A ipsam rem mollitia at tenetur. Suscipit commodi id, dolor deserunt numquam repudiandae, officia perferendis?
            </p>
          ...
          <div className="mt-[30px] lg:mt-[70px] flex  lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
            ...
            <div>
              <h2 className="text-[36px] loading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-teadingColor">
                30+
              </h2>
  ...
  <section>
    <div className="container">
      <div className="lg:w-[470px] mx-auto">
        <h2 className="heading text center"> Providing the best medical sercives</h2>
